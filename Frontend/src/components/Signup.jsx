...
console.log(authUser)
  ...
  return (
    <>
      <div className="flex min-h-screen items-center justify-center px-[40%] ">
      ...
      <form onSubmit={handleSubmit(onSubmit)}
          ...
          <label className="input input-bordered flex items-center gap-2">
            ...
            <input
              ...
              placeholder="confirm password"
               {...register("confirmPassword", { required: true , validate:validatPasswordMatch, })} 
            />
          ...
          <p >Have any Account ? <Link to ={"/login"} className=' text-blue-500 underline cursor-pointer ml-1'>{" "}
            Login</Link></p>
